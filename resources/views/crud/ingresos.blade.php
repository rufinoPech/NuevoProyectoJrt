...
<div id="rufino">
	<div class="container">
		...
		<table class="table table-hover">
            ...
            <tbody>
              <tr v-for="v in ingresos">
                <td class="success">@{{v.id_ingresos}}</td>
                ...
                <td class="success">
                  <span class="glyphicon glyphicon-pencil btn btn-xs btn-primary" data-toggle="modal" data-target="#editarvendedor" v-on:click="showIngreso(v.id_ingresos)"></span>
                  <span class="glyphicon glyphicon-trash btn btn-xs btn-danger" v-on:click="eliminar(v.id_ingresos)"></span>
                </td>
              </tr>
            </tbody>
          </table>
    ...
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <input type="text" name="concepto" placeholder="Ingreso" disabled="" class="form-control" v-model="concepto">
          <br>
          <label>Catidad</label>
          <br>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" v-on:click="agregarIngreso(id_ingresos)">Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <label>id</label>
          <input type="text" disabled="" name="id_ingresos" class="form-control" v-model="id_ingresos" placeholder="id">
          <br>
          <label>Concepto</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal" v-on:click="limpiar()">Cancelar</button>
        <button type="button" class="btn btn-primary" data-dismiss="modal" v-on:click="updateIngreso(id_ingresos)">Guardar cambios</button>
      </div>
    </div>
  </div>
</div>
...
@push('scripts')
	...
	<script src="js/crud/ingresos.js"></script>
@endpush
